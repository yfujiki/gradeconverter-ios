...
//    }
    ...
    func testGradeAtIndexes() {
        ...
        XCTAssertEqual("5.1/5.2", yosemiteGrade.localizedGradeAtIndexes([0, 1, 2]), "Grade range should match")
        XCTAssertEqual("5.10d ~ 5.11b", yosemiteGrade.localizedGradeAtIndexes([20, 21, 22, 23]), "Grade ranged should match")
        XCTAssertEqual("5.10d ~ 5.11b", yosemiteGrade.localizedGradeAtIndexes([20, 21, 22]), "Grade ranged should match")
        XCTAssertEqual("5.11a/5.11b", yosemiteGrade.localizedGradeAtIndexes([22, 23]), "Grade ranged should match")
    }
